        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mallas_mallas_MallaPadreId",
                        column: x => x.MallaPadreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EscuelaNombre = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreditoMaximo = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_configuracion", x => x.EscuelaNombre);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_niveles", x => new { x.MallaId, x.MateriaId });
                    table.ForeignKey(
                        name: "FK_niveles_mallas_MallaId",
                        column: x => x.MallaId,
                        principalTable: "mallas",
                        principalColumn: "MallaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_niveles_materias_MateriaId",
                        column: x => x.MateriaId,
                        principalTable: "materias",
                        principalColumn: "MateriaId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Matricula_DetId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MatriculaId = table.Column<int>(type: "int", nullable: false),
                    CursoId = table.Column<int>(type: "int", nullable: false)
                },
